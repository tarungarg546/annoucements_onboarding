# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-14 15:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[(b'seen', b'SEEN'), (b'yet to receive', b'YET TO RECEIVE'), (b'expired', b'EXPIRED'), (b'user left group', b'USER LEFT GROUP')], default=b'on time', max_length=10)),
